...
public class SecurityConfig {
    ...
    @Bean
    UserDetailsService userDetailsService(HttpSession httpSession) {
    ...
    SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
        ...
        http.securityMatcher("/admin/**", "/index/**", "/processinglogin", "/dangnhap/success", "/dangnhap/error",
                "/dangnhap", "/denied",
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(new AntPathRequestMatcher("/rest/products/**"))
                        .hasAnyRole("[User]", "[Admin]", "[Admin, User]")
                        ...
                        login -> {
                            try {
                                login.loginPage("/auth/dangnhap/form")
                                        ...
                                        .and()
                                        .exceptionHandling(
                                                exception -> exception.accessDeniedPage("/auth/dangnhap/denied"));
                            } catch (Exception e) {
